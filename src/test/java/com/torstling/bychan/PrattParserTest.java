...
import com.torstling.bychan.calculator.manual.MultiplicationNode;
import com.torstling.bychan.calculator.manual.MultiplicationToken;
import com.torstling.bychan.calculator.manual.NumberToken;
import com.torstling.bychan.calculator.manual.SubtractionToken;
...
import com.torstling.bychan.generic.LeftParenthesisToken;
import com.torstling.bychan.generic.RightParenthesisToken;
...
public class PrattParserTest {
    ...
    public void singleDigit() {
        ...
        PrattParser<CalculatorNode> p = new PrattParser<>(Arrays.<Token<CalculatorNode>>asList(
                ...
                createTestEndToken()));
        CalculatorNode rootNode = p.tryParseExpression(null, 0).getRootNode();
