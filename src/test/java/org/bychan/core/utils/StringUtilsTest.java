...
public class StringUtilsTest {
    ...
    public void getTextPositionAtFirst() {
        assertEquals(new TextPosition(0,1,1), StringUtils.getTextPosition(" ", 0));
    }

    @Test
    public void getTextPositionAtNewline() {
        assertEquals(new TextPosition(0,1,1), StringUtils.getTextPosition("\n", 0));
    }

    @Test
    public void getTextPositionAfterNewline() {
        assertEquals(new TextPosition(1,2,1), StringUtils.getTextPosition("\n ", 1));
    }
    ...
    public void getTextPositionStartCRLF() {
        assertEquals(new TextPosition(1,1,2), StringUtils.getTextPosition(" \r\n ", 1));
    }

    @Test
    public void getTextPositionMiddleOfCRLF() {
        assertEquals(new TextPosition(2,1,3), StringUtils.getTextPosition(" \r\n ", 2));
    }

    @Test
    public void getTextPositionAfterCRLF() {
        assertEquals(new TextPosition(3,2,1), StringUtils.getTextPosition(" \r\n ", 3));
    }
